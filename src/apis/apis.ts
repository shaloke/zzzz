...
export async function getUserInfo() {
  return request({
    url: 'https://zzzz.gzcdgd.com/api/trans/v2/trans/user/v2/info',
    method: 'GET',
  }).catch((err) => {
    throw new Error(err);
  });
...
export async function getFactorys() {
  return request({
    url: 'https://zzzz.gzcdgd.com/api/trans/v2/trans/factorys',
    method: 'GET',
  }).catch((err) => {
    throw new Error(err);
  });
...
export async function getuploadList(params: string | number) {
  return request({
    url: `https://zzzz.gzcdgd.com/api/trans/v2/trans/uploadlist?size=${params}`,
    method: 'GET',
    headers:{
      'Authorization':''
    }
...
export async function getuploadListByType(params: string | number) {
  return request({
    url: `https://zzzz.gzcdgd.com/api/trans/v2/trans/v2/uploadlist?size=${params}`,
    method: 'GET',
  }).catch((err) => {
    throw new Error(err);
  });
...
export async function getCloselyReceiver() {
  return request({
    url: `https://zzzz.gzcdgd.com/api/trans/v2/trans/v2/ref_user`,
    method: 'GET',
  }).catch((err) => {
    throw new Error(err);
  });
